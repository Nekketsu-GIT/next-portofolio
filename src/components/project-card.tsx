...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      {/* Image / Placeholder header — fixed height for grid consistency */}
      <motion.div
      ...
      >
        {image ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-yaleblue via-yaleblue/80 to-darkgoldenrod/60 flex items-center justify-center">
        ...
        {/* Floating action buttons — visible on card hover via CSS group */}
      ...
      <div className="p-5 relative z-10">
        <motion.h3
          className="text-base font-bold text-gray-900 dark:text-white mb-3 leading-snug"
          ...
          {sourceCode && (
            ...
            >
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-full px-3 py-2 border border-yaleblue text-yaleblue rounded-lg hover:bg-yaleblue dark:hover:bg-[#063672] hover:text-white transition-all duration-200 font-medium text-sm"
              >
